...
const Request = (0, request_1.default)(index_1.sequelize);
const createRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const request = yield Request.create(req.body);
...
const takeRequestInProgress = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const request = yield Request.findByPk(req.params.id);
        if (!request) {
...
const getRequestList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const requests = yield Request.findAll({ where: whereClause });
        res.json(requests);
    }
    catch (error) {
...
const cancelInProgressRequests = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield Request.update({ status: 'Отменено' }, { where: { status: 'В работе' } });
